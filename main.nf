...
def citationInfo() {
  log.info "========================= Citation ========================="
  log.info "PhyloMagnet is published in Bioinformatics and available here:"
  log.info "doi:10.1093/bioinformatics/btz799"
  log.info ""
...
def startupMessage() {
  ...
  log.info "MEGAN min overlap reads           : $params.megan_overlapreads"
  log.info "MEGAN min contig length           : $params.megan_contiglength"
  log.info "MEGAN min number reads            : $params.megan_numberreads"
  log.info "MEGAN min average coverage        : $params.megan_avcoverage"
  log.info "MEGAN min overlap contigs         : $params.megan_overlapcontigs"
  log.info "MEGAN min percent identity contigs: $params.megan_identitycontigs"
  log.info ""
...
def helpMessage() {
  ...
  log.info "--megan_overlapreads NUMBER       : MEGAN Minimum overlap for two reads"
  log.info "                                    (default 20)"
  log.info "--megan_contiglength NUMBER       : MEGAN Minimum contig length (default 200)"
  log.info "--megan_numberreads NUMBER        : MEGAN Minimum number of reads per contig"
  log.info "                                    (default 2)"
  log.info "--megan_avcoverage NUMBER         : Minimum average coverage (default 1)"
  log.info "--megan_overlapcontigs NUMBER     : MEGAN Minimum overlap for two contigs"
  log.info "                                    (default 20)"
  log.info "--megan_identitycontigs NUMBER    : MEGAN Mininum percent identity to merge "
  log.info "                                    contigs (default 99)"
  log.info ""
  log.info "Binaries location (use default if singularity image is used)"
